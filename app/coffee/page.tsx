                        ...
                        Array.from({ length: 8 }, (_, i) => i).map((_, i) => (
                            <div key={i} className='w-full h-fit relative rounded-xl mx-2'>
                                ...
                                <div className='h-1/2 relative top-1/2 bg-opacity-50 backdrop-blur-sm bg-orange-950 rounded-xl p-4 z-50'>
                                    <div className='text-white text-xl'>Brazil Peixoto Peaberry</div>
                                    <div className='w-full flex flex-row space-x-4 flex-wrap'>
                                        <div className='mt-2 flex flex-row justify-start items-center rounded-full w-fit px-4 py-1 bg-emerald-900 text-white'>
                                        ...
                                        <div className='mt-2 flex flex-row justify-start items-center rounded-full w-fit px-4 py-1 bg-yellow-900 text-white'>
                                    ...
                                    <div className='text-orange-200 italic text-extralight mt-4'>
