                            ...
                            <div key={i} className='w-full h-fit relative rounded-xl mx-2'>
                                ...
                                <div className='h-1/2 relative top-1/2 bg-opacity-50 backdrop-blur-sm bg-orange-950 rounded-xl p-4 z-50'>
                                    ...
                                    <div className='flex w-full flex-row items-center justify-between mt-4'>
                                        <a href='#' className='py-2 w-36 bg-orange-700 hover:bg-orange-600 text-black px-2 text-center rounded-lg flex justify-between'>
                                            <div>Learn More</div>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                        ...
                                        <a href='#' className='bg-emerald-700 hover:bg-emerald-600 py-2 px-2 text-center rounded-lg text-black ml-4 w-32 flex justify-between items-center'>
                                            <div>Buy</div>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
