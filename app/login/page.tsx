  ...
  return (
    ...
    <Logo />
      <div className='flex flex-row w-full h-screen overflow-hidden'>
        ...
        <Link href="/signup" replace={true} className='absolute cursor-pointer top-4 font-semibold right-4 bg-orange-600 text-black px-3 w-32 flex justify-between items-center py-2 rounded-lg'>
            <div>Sign Up</div>
          ...
          <form className='lg:w-[32rem] w-96 flex flex-col h-fit space-y-6 text-orange-300'>
            ...
            <Link href='#' className='w-full text-left text-orange-200 underline underline-offset-4 hover:text-orange-600 font-light'>Forgot my password</Link>
