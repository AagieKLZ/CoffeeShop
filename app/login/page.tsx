  ...
  return (
    ...
    <Logo />
      <div className='flex flex-row w-full h-screen overflow-hidden'>
        ...
        <Link href="/signup" replace={true} className='absolute cursor-pointer top-4 font-semibold right-4 bg-coffee-600 text-black px-3 w-32 flex justify-between items-center py-2 rounded-lg'>
            <div>Sign Up</div>
          ...
          <form className='lg:w-[32rem] w-96 flex flex-col h-fit space-y-6 text-coffee-300'>
            ...
            <Link href='#' className='w-full text-left text-coffee-200 underline underline-offset-4 hover:text-coffee-600 font-light'>Forgot my password</Link>
            <input type="submit" value="Log In" className='w-full bg-coffee-800 cursor-pointer hover:bg-coffee-900 font-semibold px-2 py-3 rounded-lg text-white mt-6 block' />
          </form>
