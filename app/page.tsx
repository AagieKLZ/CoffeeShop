    ...
    <>
      ...
      <main className='fixed inset-0 z-20 flex flex-col items-start justify-center w-full h-screen px-16 bg-transparent'>
        ...
        <div className='grid flex-wrap grid-flow-row gap-4 mt-8 md:grid-flow-col place-content-center w-fit'>
          <Link href='/coffee' className='block py-4 text-lg font-semibold text-center text-white bg-coffee-800 rounded-lg w-72 hover:bg-coffee-900'>Meet Our Coffee</Link>
        ...
        <div className='text-5xl font-semibold lg:text-6xl'>The right place for coffee lovers</div>
        <div className='mt-2 text-lg lg:text-xl'>The largest collection of coffees from all around the globe</div>
        <div className='flex flex-row flex-wrap min-w-fit'>
          <Link href='/coffee' className='block py-4 mt-8 mr-4 text-lg font-semibold text-center text-white bg-coffee-800 rounded-lg min-w-fit w-72 hover:bg-coffee-900'>Meet Our Coffee</Link>
