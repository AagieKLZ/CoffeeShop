...
export default function AmountField({ pack, price, base }: Props) {
    ...
    return (
        <div className='flex items-center justify-between w-full py-2 pb-4 border-b h-fit border-b-orange-300'>
            ...
            <div className='flex flex-col px-2 mr-4 space-y-1 text-orange-700 dark:text-orange-200'>
                <div className='text-lg font-semibold text-orange-900 dark:text-orange-300'>{pack}</div>
            ...
            {state.count > 0 &&<div className='flex items-center justify-center w-fit'>
                <div className='text-lg text-orange-800 dark:text-orange-200 w-fit'><b>Total:</b> {state.count * price}$</div>
