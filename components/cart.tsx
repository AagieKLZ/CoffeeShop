...
export default function Cart({ }: Props) {
    ...
    return (
        <div className='relative h-fit w-fit mr-8'>
            ...
            {show &&<div className='absolute animate-in slide-in-from-top-5 fade-in-20 duration-75 top-11 left-0 w-[350px] h-fit bg-orange-200 rounded-lg'>
                    <div className='flex flex-row items-center justify-around py-1 border-b-2 bg-orange-300 rounded-t-lg border-b-orange-500'>
                ...
                <div className='flex flex-row justify-between items-center px-2 py-1 border-b-orange-600 border-b text-orange-900 last:border-b-0'>
                ...
                <div className='flex flex-row justify-between px-2 py-1 border-b-orange-600 border-b last:border-b-0'>
