...
export default function Logo({ }: Props) {
  return (
    <a href='/' className='fixed top-4 left-4 z-50 flex flex-row items-center space-x-2 text-transparent bg-gradient-to-r from-orange-300 to-emerald-300 bg-clip-text'>
