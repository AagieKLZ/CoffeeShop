...
export function PlaceLabel({origin}: {origin: string}) {
  return (
    <div className="flex flex-row items-center justify-start px-4 py-1 mt-2 mr-2 rounded-full text-rose-200 bg-rose-900 w-fit">
              ...
              <div className="ml-2">{origin}</div>
            </div>
  )
}

export function RoastLabel({ roast } : { roast : string}){
    return (
...
export function PriceLabel({ price } : { price : number}){
    return (
        <div className="flex flex-row items-center justify-start px-4 py-1 mt-4 text-blue-200 bg-blue-900 rounded-full w-fit">
                  ...
                  <div className="ml-2">{price}$ / 100g</div>
                </div>
    )
}