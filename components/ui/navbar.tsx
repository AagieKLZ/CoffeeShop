...
export default function Navbar({ }: Props) {
    return (
        <nav className='fixed inset-0 w-full text-orange-900 mx-auto h-16 flex lg:justify-around justify-between lg:px-0 px-4 items-center z-[100] bg-transparnent backdrop-blur'>
